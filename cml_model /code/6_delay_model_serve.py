...
from random import randint  # PEadaptation
...
@cdsw.model_metrics
def predict_delayed(args):    # PE ... changed function name
    ...
    if prediction:                # PE ... dummy function to simulate ML pred on delay minutes
       delay = randint(1,50)      # PE 
    else:                         # PE
       delay = 0                  # PE
